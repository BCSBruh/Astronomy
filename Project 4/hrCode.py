...
ax[0, 0].plot(0.28, 20, marker='o', markerfacecolor='none', markeredgecolor='r', markeredgewidth=1.5, ms=20)
ax[0, 0].axvline(x=0.28, color='r', linestyle='dashed', label='Turnoff Line')
...
ax[0, 1].plot(0.31, 18.2, marker='o', markerfacecolor='none', markeredgecolor='r', markeredgewidth=1.5, ms=20)
...
ax[1, 0].plot(0.38, 21.2, marker='o', markerfacecolor='none', markeredgecolor='r', markeredgewidth=1.5, ms=20)
ax[1, 0].axvline(x=0.38, color='r', linestyle='dashed', label='Turnoff Line')
ax[1, 0].text(0.45, 21.2, "Turnoff Point", fontsize=10, color='r')
ax[1, 0].set_xlim(0.2, 1)
ax[1, 0].set_ylim(16, 24.5)
ax[1, 0].invert_yaxis()
...
ax[1, 1].plot(0.23, 19, marker='o', markerfacecolor='none', markeredgecolor='r', markeredgewidth=1.5, ms=20)
